 ...
 * @author sebas
 */
public class RetiroVista extends JFrame{
    public RetiroVista() {
        setTitle("Retirar");
        setSize(400, 300);
        setContentPane(new JLabel(new ImageIcon("recursos/Retiro.png")));
        setLayout(null);
        ...
        btn.addActionListener(e -> {
            ...
            String respuesta = controller.retirar(new Cuenta(cuenta, monto));
